 ...
 */
export function placeSimMarketOrder(account: SimAccountState, side: SimSide, qty: number, price: number, time: number, pointValue: number = SIM_POINT_VALUE): SimAccountState {
